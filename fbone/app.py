...
from .extensions import db, mail, cache, login_manager, oid, mongo
from .utils import INSTANCE_FOLDER_PATH
from muser.models import MUser
from muser.views import muser
...
def configure_extensions(app):
    ...
    # flask-login
    login_manager.login_view = 'top.login'

    @login_manager.user_loader
    def load_user(id):
        return MUser.get_by_id(_id=id)
